...
const Credit = () => {
  return (
    <div className='bg-[#FCD0BA] text-black md:p-0 md:flex-row md:p-15 flex flex-col gap-5 text-3xl  md:p-30 md:text-7xl md:flex justify-center md:justify-around md:items-start md:gap-50'>
